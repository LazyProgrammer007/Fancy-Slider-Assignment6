...
const countingImage = document.getElementById('countingImage');
// selected image 
let sliders = [];
...
const selectItem = (event, img) => {
  ...
  countingImage.innerText = `${sliders.length} Images Selected`;
}
var timer
const createSlider = () => {
  ...
  const duration = Math.abs(document.getElementById('slideDuration').value) || 1000;
...
enterPress(slideDuration, sliderBtn)
